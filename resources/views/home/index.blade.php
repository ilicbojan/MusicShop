...
<div id="carouselExampleCaptions" class="carousel slide mt-n4" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/storage/uploads/home-1.jpg" class="d-block w-100" alt="..." style="height: 600px">
    ...
    <div class="carousel-item">
      <img src="/storage/uploads/home-2.jpg" class="d-block w-100" alt="..." style="height: 600px">
      <div class="black-overlay"></div>
      <div class="carousel-caption d-none d-md-block">
        <h5>Drums</h5>
    ...
    <div class="carousel-item">
      <img src="/storage/uploads/home-3.jpg" class="d-block w-100" alt="..." style="height: 600px">
      <div class="black-overlay"></div>
      <div class="carousel-caption d-none d-md-block">
...
<h3 class="mt-5">Popular Products</h3>
<div class="card-deck">
  @foreach($products as $product)
  <div class="col-10 col-sm-6 col-md-5 col-lg-3 col-xl-3 mx-auto my-5 my-sm-3 my-lg-4 px-xl-3">
...
<h3 class="mt-3 mb-4">Follow Us</h3>
<div class="row px-3 social-links" style="height: 100px">
  <div class="col-4 p-0">
